...
Name: "{userdesktop}\Five Nights at Freddy's 1"; Filename: "{app}\installer_updater.exe"; IconFilename: "{app}\fnaf_2.ico"; Comment: "Lanzador de Five Nights at Freddy's 1"; WorkingDir: "{app}"

; Acceso directo en el menú de inicio dentro de la carpeta StormGamesStudios
Name: "{commonprograms}\StormGamesStudios\Five Nights at Freddy's 1"; Filename: "{app}\installer_updater.exe"; IconFilename: "{app}\fnaf_2.ico"; Comment: "Lanzador de Five Nights at Freddy's 1"; WorkingDir: "{app}"
Name: "{commonprograms}\StormGamesStudios\Desinstalar Five Nights at Freddy's 1"; Filename: "{uninstallexe}"; IconFilename: "{app}\fnaf_2.ico"; Comment: "Desinstalar Five Nights at Freddy's 1"
